  ...
  '<body>' +
      ...
      '<div class="large-1 columns">' +
        '<div id="signinup">' +
          '<form action=" /uploadedfile"  enctype="multipart/form-data" method="post">' +
            '<input id="sub" type="file" name="upload" multiple="multiple" id="newImage">' +
            '<input id="sub" type="submit" value="THEN click here to show the picture in the browser!" id="uploadButton" />' +
          '</form>' +
    ...
    '<div class="row">' +
      ...
      '<div class="contact-info">' +
        ...
        '<br>' +
        '<a href="contact.html">Contact the Colo(u)rBlindr team</a>' +
      '</div>' +
    '</div>' +
